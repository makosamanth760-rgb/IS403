...
function getDBConnection() {
    ...
    if ($conn->connect_error) {
        ...
        $error_msg .= "<ul>";
        $error_msg .= "<li>Database: " . htmlspecialchars($db_database) . "</li>";
        ...
        $error_msg .= "<li>Update the password in <code>config/database.php</code> - Change line 5: <code>\$db_password = \"your_password\";</code></li>";
    ...
    $sql = "CREATE DATABASE IF NOT EXISTS `" . $conn->real_escape_string($db_database) . "` CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci";
